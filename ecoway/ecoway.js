...
const ecowayDOM = document.querySelector(".product-box-container");
...
class Products {
  async getProducts() {
    try {
      let result = await fetch("../jsonFolder/ecoway.json");
