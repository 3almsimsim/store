...
const A5ColoredDOM = document.querySelector(".product-box-container");
...
class Products {
  async getProducts() {
    try {
      let result = await fetch("../../../jsonFolder/A5Colored.json");
