...
const correctorDOM = document.querySelector(".product-box-container");
...
class Products {
  async getProducts() {
    try {
      let result = await fetch("../../jsonFolder/corrector.json");
